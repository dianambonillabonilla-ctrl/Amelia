...
// Solo Usuarios, Sincronización FUDO y Caja aparecen en reactivación; Historial de Caja pertenece al mismo módulo Caja.
...
assert.match(config,/href: 'historial-caja\.html', texto: 'Historial de Caja', soloRol: \['Administrador'\]/);
...
assert.match(historialCaja,/requerirRol_\(\['Administrador'\]\)/);
