...
function construirEntorno_() {
  ...
  // millón (ya lo tiene la administradora, la caja fuerte física de San Antonio está en cero)
  // también el 2026-08-03 — antes de cualquier fecha real de uso, porque cajaV2SaldoFuerteAntes_
  // solo cuenta movimientos estrictamente ANTERIORES a la fecha consultada: si se fecha el mismo
  // día que "hoy", ese día todavía muestra la diferencia vieja. Son correcciones de hechos reales
  // (una migración de datos, no algo que estas pruebas deban ejercitar), así que se pre-cargan sus
  // IDs para que la migración los vea como "ya existentes" y no los repita — igual que en el
  // deployment real después de la primera vez que corrió.
  const movimientos = [
