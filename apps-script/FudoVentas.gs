 ...
 * bebida confiable, Fudo_Items debe conservarla VACÍA. No se convierte a 0 como si FUDO hubiera
 * informado una cantidad real de cero. El valor económico de la línea se conserva por separado.
 */
...
function fudoVentasCabeceraDesdeItems_(idVenta, items) {
  ...
  items.forEach(function (it) {
    ...
    // `precio` es el total económico de la línea. No depende de que la cantidad sea confiable.
