...
function migrarRecetasJulio2026_() {
  ...
  const lineasSubreceta = [
    ...
    { producto: 'Papas Listas', ingrediente: 'Sal normal', cantidad: 10, unidad: 'g', rendimiento_producto: 1000, unidad_rendimiento: 'g', tipo: 'produccion', estado: 'activo', controla_disponibilidad: true, fuente: 'RECETAS_FINAL_DILANA_OS v3, hoja SUBRECETAS (16 jul 2026)', version: 'julio_2026', notas: 'Corregido: las Papas Listas se hacen con Sal normal, no Sal marina (confirmado con Diana).' },
